...
#Data for Carcinod re-analysis using data form Garbiel et al (2020)
#Quantile quantile normalization performed on data from Gabriel et al (2020)
#load packages
```{r}
rm(list=ls())
library(umap) 
...
#Attributes = read.table(unzip(paste0(project_path,'Attributes.txt.zip'),exdir = paste0(project_path,"zip_extract"))[1], sep = '\t', header = T)
Attributes = read.table("Attributes.txt",sep = '\t', header = T)
Attributes[1:5,1:10]
...
# Atypical           Carcinoid               LCNEC  LCNEC combined ADC LCNEC combined SCLC LCNEC combined SqCC                SCLC 
# 40                   3                  56                   1                   9                   3                  51 
# Typical 
# 75 
summary(Attributes$Molecular_clusters)
# Carcinoid-A1    Carcinoid-A2     Carcinoid-B             LC1             LC2             LC3        LCNEC/NA LCNEC/SCLC-like     LCNEC/TypeI 
# 33              32              20              15               8               7               3              11              30 
# LCNEC/TypeII SCLC/LCNEC-like  SCLC/SCLC-like Supra_carcinoid 
# 25               9              42               3 
...
read_counts = read.table("read_counts_all.txt", header = T, row.names=1)
